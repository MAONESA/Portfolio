// Página de inicio one-page con modo móvil “compacto”
...
// Si no instalas lucide-react, usa el SVG inline que te pasé antes
...
function Home() {
  ...
  return (
    <div className="relative">
      {/* Dots: en móvil sin tooltips; para ocultarlos en móvil pasa hidden={true} */}
      <ScrollDots
        sections={sections}
      ...
      >
        ...
        <section id="about" className="h-svh w-full snap-start">
          <div className={`container h-full grid items-center gap-8 ${isMobile ? "grid-cols-1" : "grid-cols-1 md:grid-cols-2"}`}>
            <div className="min-w-0 space-y-4">
              ...
              <div className="flex flex-wrap items-center gap-3 pt-1">
                <a href="/cv.pdf" className="rounded-2xl bg-[--color-neon] px-5 py-2 font-medium text-black shadow-xl transition hover:brightness-110">
                  Descargar CV
                </a>
                {!isMobile && (
            ...
            <div className="flex justify-center">
              <div className={`relative ${isMobile ? "size-44" : "size-56 md:size-72"} rounded-full bg-[--color-graphite] ring-2 ring-white/10 shadow-[var(--shadow-cyan)] overflow-hidden`}>
              ...
              <div className="mt-8 flex flex-col gap-8 md:flex-row md:items-start md:gap-10">
                {[
                  ...
                  <div key={s.title} className="relative flex items-start md:flex-1">
                    {idx < arr.length - 1 && <div className="absolute left-6 top-5 hidden h-[2px] w-[calc(100%-1.5rem)] bg-white/10 md:block" />}
        ...
        <section id="certifications" className="h-svh w-full snap-start safe-bottom">
          <div className="container h-full flex flex-col justify-center">
            ...
            {/* Footer integrado dentro de la última sección */}
